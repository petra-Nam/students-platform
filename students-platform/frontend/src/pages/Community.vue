  ...
  <div class="min-h-screen bg-gradient-to-br from-green-50 to-green-100">
    <div class="max-w-6xl mx-auto px-4 py-20">
      <div class="text-center mb-16">
        ...
        <p class="text-xl text-gray-700 max-w-2xl mx-auto mb-10 leading-relaxed">
          Explore discussions, share your experiences, and grow together with our supportive community.
        </p>
      </div>
    </div>
    ...
    <div class="max-w-6xl mx-auto px-4 py-5" v-if="hasSearched">
      <div class="bg-white rounded-xl shadow-lg p-10">
        ...
        <div v-else-if="communityPosts.length === 0" class="text-center text-gray-600 text-lg">
...
const communityPosts = ref<any[]>([]); // Holds the list of community posts
...
/**
 * Fetches community posts from the API for the *current* page.
 */
const fetchCommunityPosts = async () => {
  ...
  try {
    ...
    console.error("Error fetching community posts:", (error as Error).message);
    communityPosts.value = []; // Clear results on error
  } finally {
